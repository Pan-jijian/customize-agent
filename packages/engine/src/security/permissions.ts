...
const DEFAULT_CONFIG: PermissionConfig = {
  ...
  rules: [
    ...
    },
    {
      ...
      commandPatterns: [
        // ⚠️ deny 规则必须放在最前面，优先匹配。否则 allow 可能先匹配到危险命令的子串。
        // ── deny: 危险命令（Unix） ──
        ...
        { pattern: 'del /f /s /q *', permission: 'deny' },
        { pattern: 'rmdir /s /q', permission: 'deny' },
        { pattern: 'reg delete**', permission: 'deny' },
        { pattern: 'bcdedit**', permission: 'deny' },
        { pattern: 'icacls** /deny**', permission: 'deny' },
        { pattern: 'takeown**', permission: 'deny' },
        { pattern: 'shutdown**', permission: 'deny' },
        { pattern: 'rundll32**', permission: 'deny' },
        ...
        { pattern: 'where **', permission: 'allow' },
        { pattern: 'tasklist **', permission: 'allow' },
        { pattern: 'cd **', permission: 'allow' },
        { pattern: 'more **', permission: 'allow' },
        { pattern: 'fc **', permission: 'allow' },
        { pattern: 'comp **', permission: 'allow' },
        { pattern: 'set **', permission: 'allow' },
        { pattern: 'ver **', permission: 'allow' },
        { pattern: 'systeminfo **', permission: 'allow' },
        { pattern: 'driverquery **', permission: 'allow' },
        { pattern: 'path **', permission: 'allow' },
        { pattern: 'cls **', permission: 'allow' },
        ...
        { pattern: 'md **', permission: 'allow' },
        { pattern: 'rd **', permission: 'allow' },
        { pattern: 'ren **', permission: 'allow' },
        { pattern: 'rename **', permission: 'allow' },
        { pattern: 'sort **', permission: 'allow' },
        // ── ask: 脚本/构建/解释器命令可能产生写入或网络副作用 ──
        { pattern: 'pnpm **', permission: 'ask' },
        { pattern: 'npm **', permission: 'ask' },
        { pattern: 'yarn **', permission: 'ask' },
        { pattern: 'tsc **', permission: 'ask' },
        { pattern: 'node **', permission: 'ask' },
        { pattern: 'python **', permission: 'ask' },
        { pattern: 'python3 **', permission: 'ask' },
        { pattern: 'cargo **', permission: 'ask' },
        { pattern: 'go **', permission: 'ask' },
        { pattern: 'make **', permission: 'ask' },
        { pattern: 'cmake **', permission: 'ask' },
        // ── ask: Windows 脚本/构建命令 ──
        { pattern: 'powershell**', permission: 'ask' },
        { pattern: 'pwsh**', permission: 'ask' },
        { pattern: 'msbuild**', permission: 'ask' },
        { pattern: 'dotnet**', permission: 'ask' },
        { pattern: 'nuget**', permission: 'ask' },
        { pattern: 'choco**', permission: 'ask' },
        { pattern: 'winget**', permission: 'ask' },
        { pattern: 'scoop**', permission: 'ask' },
        { pattern: 'reg**', permission: 'ask' },
        { pattern: 'wmic**', permission: 'ask' },
        { pattern: 'sc**', permission: 'ask' },
        { pattern: 'net**', permission: 'ask' },
        { pattern: 'netsh**', permission: 'ask' },
      ],
    },
  ],
};
