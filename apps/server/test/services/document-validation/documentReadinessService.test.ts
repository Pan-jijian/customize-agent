...
import type { MaterialRole, ProjectMaterialSummary, MaterialEvidenceRef } from '@/services/document-core/projectMaterialService';
import type { ResolvedMaterialRole } from '@/services/document-core/materialRoleResolver';
import type { DocumentTemplate, DocumentTemplateChapter } from '@/services/document-workflow/types';
import { evaluateDocumentReadiness, readinessPrompt, type DocumentGenerationReadiness } from '@/services/document-validation/documentReadinessService';
