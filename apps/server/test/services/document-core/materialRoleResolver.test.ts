...
import type { MaterialEvidenceRef, MaterialRole, ProjectMaterialSummary } from '@/services/document-core/projectMaterialService';
import type { DocumentTemplate, DocumentTemplateChapter } from '@/services/document-workflow/types';
import { resolveTemplateMaterialRoles } from '@/services/document-core/materialRoleResolver';
