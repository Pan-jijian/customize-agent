...
import type { KnowledgeFileDiscoveryItem } from '@/services/knowledge/kbService';

vi.mock('@/services/knowledge/kbService', () => ({
  listKnowledgeFiles: vi.fn(() => [] as KnowledgeFileDiscoveryItem[]),
}));

import { listKnowledgeFiles } from '@/services/knowledge/kbService';
import { buildProjectMaterialSummary, projectMaterialPrompt, type ProjectMaterialSummary } from '@/services/document-core/projectMaterialService';
