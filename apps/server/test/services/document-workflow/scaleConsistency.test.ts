...
import { buildFactsModel, detectFactConflicts, fieldExtractionPattern } from '@/services/document-workflow/factsModel';
import { buildCanonicalFactModel, detectNumericScopeConflicts } from '@/services/document-workflow/factGovernance';
