...
import { DOCUMENT_WORKFLOW_VERSION } from '@/services/document-workflow/documentWorkflowVersion';

describe('DOCUMENT_WORKFLOW_VERSION', () => {
  it('版本与规则清单', () => {
    expect(DOCUMENT_WORKFLOW_VERSION.version).toBe('professional-document-workflow-v12');
