  ...
  it('汇总 LLM/证据/质量与慢指标 Top5（按耗时降序）', () => {
    ...
    const report = buildDocumentTelemetryReport({
      diagnostics: makeDiagnostics({
        ...
        evidence: { raw: 10, used: 8, filteredNoise: 1, budgetDropped: 1, avgNoiseScore: 0.1, avgFactDensity: 0.8, searchQueries: 5, searchMs: 100, contextChars: 3000, t0Chars: 0, t1Chars: 0, t2Lines: 0, omittedChars: 0 },
