...
vi.mock('@/services/document-workflow/tenderBidScoring', () => ({
...
import type { DocumentDraftChapter, DocumentFactTrace, DocumentKnowledgeCoverageReport, DocumentQualityReport, ValidationIssue } from '@/services/document-workflow/types';
