...
import { collectDocumentHeadings, formatKnownConflictLines, sanitizeIssueLocation, scanCrossChapterDataConflicts } from '@/services/document-workflow/crossChapterDataScan';
