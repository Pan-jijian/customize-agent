/**
 * 评审模块承接小节（reviewModuleSections）单测：丰乐镇 R12 评分归因——6 强制模块与劳务保障制度
 * 在规划层显性承接（小节标题即评审查询原词）。本测试锁定：
...
import { injectReviewModuleSections } from '@/services/document-workflow/reviewModuleSections';
