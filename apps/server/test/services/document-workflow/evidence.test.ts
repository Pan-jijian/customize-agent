...
import type { DocumentEvidence, DocumentGenerationDiagnostics, DocumentGenerationStrategy, DocumentTemplateChapter } from '@/services/document-workflow/types';
import {
  buildEvidenceBundle,
  buildEvidenceLayers,
  cleanEvidenceText,
  ...
  uniqueEvidence,
} from '@/services/document-workflow/evidence';
