...
vi.mock('@/services/document-workflow/referenceQualityProfile', () => ({
  buildReferenceQualityProfile: buildReferenceQualityProfileMock,
  suggestProjectType: suggestProjectTypeMock,
}));
vi.mock('@/services/document-workflow/templateReferenceService', () => ({
  referenceBenchmarkForType: referenceBenchmarkForTypeMock,
}));

import { benchmarkGeneratedMarkdown } from '@/services/document-workflow/benchmarkQuality';
