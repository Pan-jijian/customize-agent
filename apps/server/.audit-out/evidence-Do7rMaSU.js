import "node:fs";
import { IndexStateStore, computeProjectId, loadBetterSqlite3 } from "@customize-agent/knowledge";
...
*/
function readProjectKbChunkTextsByHints(projectRoot, hints, options = {}) {
	try {
		const dbPath = path$1.join(os$1.homedir(), ".customize-agent", "projects", computeProjectId(path$1.resolve(projectRoot)), "kb.db");
...
//#endregion
export { init_kbService as A, init_projectMaterialService as C, explicitLengthTargets as D, documentTextLength as E, __commonJSMin as M, __esmMin as N, init_budget as O, __exportAll as P, init_configService as S, init_constants as T, init_llmClient as _, init_templateStore as a, BID_DISCIPLINE_PHRASES as b, init_projectGraph as c, init_constructionOrgTablePlan as d, init_writingSpec as f, concurrencyForDocumentScale as g, init_semanticSimilarity as h, normalizePlannedSectionTitle as i, readProjectKbChunkTextsByHints as j, getProjectRoot as k, docSystemPrefix as l, init_semanticGate as m, init_factMatching as n, init_projectMaterialProfile as o, init_workflowRules as p, init_outline as r, init_agentWorkflow as s, init_evidence as t, init_markdownComposer as u, init_tuningProfile as v, init_documentRoleService as w, init_utils as x, tuningProfile as y };
