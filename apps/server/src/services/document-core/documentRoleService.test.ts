...
import type { DocumentRole, ProjectRoleConfig } from '../types';
import { writeEngineeringDocumentConfig, type EngineeringDocumentConfig } from '../document-validation/engineeringDocumentConfigService';
import {
  deleteDocumentRole,
