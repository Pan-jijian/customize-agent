...
import type { GateRuleEvaluator } from '../document-core/autoDocumentSpecTypes';
import type { DocumentDraftChapter, DocumentFact, DocumentFactsModel, PromptBinding } from '../document-workflow/types';
import type { SpecGateRuleContext } from '../types/qualityValidationTypes';
import {
  CHAPTER_HEADING_RE,
  ...
  TOC_SECTION_LINE_RE,
  WHITESPACE_RE,
} from './qualityValidationConstants';
