...
export async function buildStandardFinalValidationIssues(input: {
  ...
  return [
    ...
    ...det('blueprint-value-placement', () => blueprintValuePlacementIssues(input.markdown, input.blueprintData)),
    // 4.55.20 悬空连接词截断（「…平面位置和。」类半截句）
    ...det('dangling-conjunction', () => danglingConjunctionIssues(input.markdown)),
