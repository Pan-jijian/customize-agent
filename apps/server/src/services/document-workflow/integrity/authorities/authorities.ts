...
// r6 实机归因（#3 劳动力「景观与绿化工程阶段保持262人 vs 绿化工班组57人」误报）：
// 「绿化工」⊂「绿化工程」、「混凝土工」⊂「混凝土工程」、「操作工」⊂「操作工艺」等子串误匹配把
// 工程/工序/工艺/工期词误判为工种口径（laborGroupOf），与真工种班组数互查报假矛盾——
// 负向前瞻排除「X工+程/序/艺/期」形态（连续四类后缀必为工程/工序/工艺/工期词，真工种配置如
// 「绿化工班组57人」后接人力/分隔符不受影响）

export const TRADE_WORKER_WORD_RE = /(?:铺装工|钢筋工|混凝土工|架子工|砌筑工|抹灰工|防水工|油漆工|水暖工|水电工|管道工|电焊工|起重工|机械工|司索工|信号工|塔吊司机|测量工|试验工|绿化工|管网工|装修工|装饰工|安装工|养护工|保温工|幕墙工|防腐工|操作工|市政工|模板工|木工|瓦工|焊工|电工|普工)(?!程|序|艺|期)/u;
