...
export async function buildFullValidationIssues(input: {
  ...
  /** 4.55.36 批次 2 答疑技术性修正账本（写作注入同一份）：修正前形态残留/修正未落位终检 */
