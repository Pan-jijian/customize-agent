...
vi.mock('./templateStore', () => ({ getDocumentTemplate: mocks.getDocumentTemplateMock }));
vi.mock('./evidence', () => ({ evidenceLine: mocks.evidenceLineMock }));
vi.mock('./outline', () => ({ displayChapterTitle: mocks.displayChapterTitleMock }));
vi.mock('./factMatching', () => ({ evidenceMatchesFact: mocks.evidenceMatchesFactMock }));
vi.mock('./rolePipeline', () => ({ evidenceInScope: mocks.evidenceInScopeMock }));
vi.mock('./projectMaterialProfile', () => ({
...
vi.mock('./documentGeneratorHelpers', () => ({
...
import { regenerateDocumentChapter } from './documentRegeneration';
import type { DocumentEvidence, DocumentTemplate, DocumentTemplateChapter } from './types';
