...
export interface ExportReport { format: 'markdown' | 'html' | 'pdf' | 'docx'; exportedAt: number; durationMs?: number; benchmarkScore?: number; benchmarkSourceCount?: number; ruleSummary?: string[]; repairedCount?: number; blockingCount?: number; gatePassed?: boolean; healthAlerts?: string[]; repairHeat?: Record<string, { hits: number; repaired: number; failed: number }> }
